...
<header
    class={"sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid " +
        (y > 0
            ? " py-4 bg-slate-950 border-red-950"
            : " py-6 bg-transparent border-transparent")}
>
    <h1 class="font-medium">
         <span class="font-bold poppins">Trần Minh Tiến</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        >
            <div
                class="absolute top-0 right-full w-full h-full bg-red-600 opacity-20 group-hover:translate-x-full z-0 duration-200"
            ></div>
